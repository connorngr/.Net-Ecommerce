...
namespace WebApp.Migrations
{
    ...
    [Migration("20240409010325_add-phone-order")]
    partial class addphoneorder
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebApp.Areas.Identity.Data.User", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("WebApp.Areas.Identity.Data.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("WebApp.Models.Order", b =>
                {
                    ...
                    b.HasOne("WebApp.Areas.Identity.Data.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
